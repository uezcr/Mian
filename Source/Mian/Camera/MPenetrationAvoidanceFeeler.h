...
#include "MPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FMPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FMPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
