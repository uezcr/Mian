...
#include "MGameplayCueManager.generated.h"
...
UCLASS()
class UMGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UMGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UMGameplayCueManager* Get();
