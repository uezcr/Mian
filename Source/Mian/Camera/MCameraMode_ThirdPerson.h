...
#include "MPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "MCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UMCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UMCameraMode_ThirdPerson : public UMCameraMode
{
	GENERATED_BODY()
...
public:
	 ...
	 *             impacting the occlude.
	 */
	UPROPERTY(EditDefaultsOnly, Category = "Collision")
	TArray<FMPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
