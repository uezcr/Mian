...
#include "MSystemStatics.generated.h"
...
UCLASS()
class UMSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="M", meta = (WorldContext = "WorldContextObject"))
