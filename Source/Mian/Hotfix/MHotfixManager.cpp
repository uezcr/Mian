#include "Hotfix/MHotfixManager.h"
#include "UObject/UObjectIterator.h"
#include "Engine/NetDriver.h"
#include "DeviceProfiles/DeviceProfileManager.h"
#include "DeviceProfiles/DeviceProfile.h"
//TODO #include "Settings/MSettingsLocal.h"
#include "HAL/MemoryMisc.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(MHotfixManager)

int32 UMHotfixManager::GameHotfixCounter = 0;

UMHotfixManager::UMHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &UMHotfixManager::GetOnScreenMessages);
...
void UMHotfixManager::Init()
{
	Super::Init();
}

void UMHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		//TODO UMSettingsLocal* GameSettings = UMSettingsLocal::Get();
		//TODO GameSettings->OnHotfixDeviceProfileApplied();
	}
...
bool UMHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UMHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool UMHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
void UMHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void UMHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
...
bool UMHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void UMHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void UMHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles,
...
#if !UE_BUILD_SHIPPING
void UMHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
