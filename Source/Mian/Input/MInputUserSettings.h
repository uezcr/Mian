...
#include "MInputUserSettings.generated.h"

/** 
 * Custom settings class for any input related settings for the M game.
 * This will be serialized out at the same time as the M Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class MIAN_API UMInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MIAN_API UMPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
